...
<aside
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0 d-flex text-wrap align-items-center" href=" {{ route('dashboard') }} ">
            ...
            <span class="ms-2 font-weight-bold text-white">Employes Management</span>
        </a>
    </div>
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'users' ? 'active bg-gradient-primary' : '' }} "
                    ...
                    <span class="nav-link-text ms-1">Employes</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'positions' ? 'active bg-gradient-primary' : '' }} "
                    href="{{ route('positions.index') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i style="font-size: 1.2rem;" class="fas fa-sitemap ps-2 pe-2 text-center"></i>
                    </div>
                    <span class="nav-link-text ms-1">Position</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'attendance' ? 'active bg-gradient-primary' : '' }} "
                    href="{{ route('attendances.index') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i style="font-size: 1.2rem;" class="fas fa-calendar-check ps-2 pe-2 text-center"></i>
                    </div>
                    <span class="nav-link-text ms-1">Attendance</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'salary_types' ? 'active bg-gradient-primary' : '' }} "
                    href="{{ route('salary_types.index') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i style="font-size: 1.2rem;" class="fas fa-briefcase ps-2 pe-2 text-center"></i>
                    </div>
                    <span class="nav-link-text ms-1">Salary Type</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'totalsalary' ? 'active bg-gradient-primary' : '' }} "
                    href="{{ route('totalsalary') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i style="font-size: 1.2rem;" class="fas fa-dollar-sign ps-2 pe-2 text-center"></i>
                    </div>
                    <span class="nav-link-text ms-1">Total Salary</span>
                </a>
            </li>
            <!-- <li class="nav-item">
